...
import { ArrowLeft, Download, Trash2, FileText, Calendar, User, Filter, Search, Shield } from 'lucide-react';
...
const AdminViewAllDocument: React.FC = () => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center mb-8">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-3xl font-bold text-white">Admin Document Management</h1>
              <p className="text-gray-300 mt-2">View and manage all system documents</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 overflow-hidden">
          {/* Stats Bar */}
          <div className="p-6 bg-gradient-to-r from-red-600/20 to-purple-600/20 border-b border-white/10">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-white">
                  {Math.round(documents.reduce((acc, doc) => acc + parseFloat(doc.fileSize), 0) * 100) / 100} MB
                </div>
                <div className="text-sm text-gray-300">Total Storage</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-white">
                  {new Set(documents.map(doc => doc.uploadedBy)).size}
                </div>
              ...
              <div className="flex-1">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2 bg-white/5 border border-white/20 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all"
                    placeholder="Search documents, files, or users..."
                  />
                </div>
              </div>
              ...
              <div className="md:w-48">
                <div className="relative">
                  ...
                  <select
                    ...
                    className="w-full pl-10 pr-4 py-2 bg-white/5 border border-white/20 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all appearance-none"
                  >
                ...
                <tbody className="divide-y divide-white/10">
                  {filteredDocuments.map((doc) => (
                    <tr key={doc.id} className="hover:bg-white/5 transition-colors">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className="inline-flex px-2 py-1 text-xs font-semibold rounded-full bg-red-600/20 text-red-300">
                          {doc.category}
                        </span>
                      </td>
          ...
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 max-w-md w-full">
              ...
              <p className="text-gray-300 mb-6">
                Are you sure you want to delete this document? This action cannot be undone and will affect the user who uploaded it.
              </p>
...
export default AdminViewAllDocument;